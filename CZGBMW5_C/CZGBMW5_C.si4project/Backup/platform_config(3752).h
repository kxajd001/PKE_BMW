...
#define GPIO_NXP_OPEN                   GPIOB         //控制NXP解锁键，LF接收
#define GPIO_PIN_NXP_OPEN               GPIO_Pin_3
...
#else
#define READ_UHF_IN                     GPIO_ReadInputDataBit(GPIO_CTRL_KEY, GPIO_PIN_CTRL_KEY2)    //用于测试
#endif
#define READ_STUDY_IN                   GPIO_ReadInputDataBit(GPIO_STUDY_IN, GPIO_PIN_STUDY_IN) 
     
//#define VIR_START_KEY1_ON               GPIO_SetBits(GPIO_CTRL_KEY, GPIO_PIN_CTRL_KEY1)
//#define VIR_START_KEY1_OFF              GPIO_ResetBits(GPIO_CTRL_KEY, GPIO_PIN_CTRL_KEY1)
//#define VIR_START_KEY2_ON               GPIO_SetBits(GPIO_CTRL_KEY, GPIO_PIN_CTRL_KEY2)
//#define VIR_START_KEY2_OFF              GPIO_ResetBits(GPIO_CTRL_KEY, GPIO_PIN_CTRL_KEY2)
...
//#define NXP_REMOTE_SEND_ON              GPIO_ResetBits(GPIO_NXP_LOCK, GPIO_PIN_NXP_LOCK)
//#define NXP_REMOTE_SEND_OFF             GPIO_SetBits(GPIO_NXP_LOCK, GPIO_PIN_NXP_LOCK)
...
//#define NXP_UART_HIGH                   GPIO_SetBits(GPIO_NXP_LOCK, GPIO_PIN_NXP_LOCK)
//#define NXP_UART_LOW                    GPIO_ResetBits(GPIO_NXP_LOCK, GPIO_PIN_NXP_LOCK)
//#define TESTOUT                       (GPIO_WriteBit(GPIO_NXP_OPEN, GPIO_PIN_NXP_OPEN, (BitAction)((1-GPIO_ReadOutputDataBit(GPIO_NXP_OPEN, GPIO_PIN_NXP_OPEN)))))
//#define TESTOUT_LOW                   ((void)0) //GPIO_ResetBits(GPIO_NXP_OPEN, GPIO_PIN_NXP_OPEN)
//#define TESTOUT_HIGH                  ((void)0) //GPIO_SetBits(GPIO_NXP_OPEN, GPIO_PIN_NXP_OPEN)
#define NXP_LED_ON                      GPIO_ResetBits(GPIO_NXP_OPEN, GPIO_PIN_NXP_OPEN)
#define NXP_LED_OFF                     GPIO_SetBits(GPIO_NXP_OPEN, GPIO_PIN_NXP_OPEN)
#define NXP_LED_TOG                     (GPIO_WriteBit(GPIO_NXP_OPEN, GPIO_PIN_NXP_OPEN, (BitAction)((1-GPIO_ReadOutputDataBit(GPIO_NXP_OPEN, GPIO_PIN_NXP_OPEN)))))
//#define NXP_LED_OFF                   ((void)0)
//#define NXP_LED_TOG                   ((void)0)
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
